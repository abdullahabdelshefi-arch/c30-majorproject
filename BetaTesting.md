...
- The enemies are too fast slow them down as time goes on you can make them faster 
- Reload time could be faster ✅
- Let player be able to use arrow keys
- Super power where if you last a certian time you can have a bar to make a super power
- Sound effects are nice
- Make space ship enemies look more real
- Enemies that hit u
